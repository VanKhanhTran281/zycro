    ...
    return (
        <div style={{ marginTop: '16px', height: '232px', borderRadius: '8px', backgroundColor: '#F7F8FA' }}>
            <div style={{ height: '52px', display: 'flex' }}>
                ...
                <svg style={{ marginLeft: '15px', marginTop: '20px' }} width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div style={{ display: 'flex' }}>
                            <div style={{ height: '52px', width: '808px' }}>
                                <div style={{ display: 'flex', height: '32px', marginLeft: '5px' }}>
                                    ...
                                    <div onClick={handleUpdateExisting} style={{ border: isDropdown ? '1px solid #E0E4F0' : '1px solid #3490F6', width: '111px', marginLeft: '9px', marginTop: '7px', display: 'flex', alignItems: 'center', borderRadius: '8px', height: '32px' }}>
                                        <input readOnly style={{ outline: 'none', border: 'none', width: '63px', height: '18px', marginLeft: '9px' }} placeholder={selectedOption} />
                                ...
                                {!isDropdown && (
                                    <div style={{ borderRadius: '8px', border: '0.5px solid #E0E4F0', marginLeft: '78px', marginTop: '15px', width: "154px", height: '128px', position: 'relative', backgroundColor: '#fff', zIndex: '9999' }}>
                            ...
                            <svg style={{ marginTop: "11px" }} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
