    ...
    const columns = [
        ...
        { title: "Last Updated", dataIndex: "last_updated", key: "last_updated" },
        {
            ...
            render: (_: any, record: ContactsData, index: number) => (
                <>
                    <svg style={{ fontSize: '30px', marginLeft: '15px' }} onClick={() => handleThreeDotsClick(index)} width="14" height="4" viewBox="0 0 14 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {showFormArray[index] && selectedRowIndex === index && (
                        ...
                        >
                            <div style={{ marginTop: '-5px' }}>
                                ...
                                <span style={{ display: 'flex', alignItems: 'center', marginLeft: '10px' }} onClick={() => handleDeleteClick(record)}>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
